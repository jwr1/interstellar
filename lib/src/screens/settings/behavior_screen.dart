      ...
      body: ListView(
        children: [
          ...
          ListTileSelect(
            ...
            onChange: (newValue) {
              var newActions = List<SwipeAction>.from(ac.selectedProfileValue.swipeActions?? ac.profile.swipeActions);
          ...
          ListTile(
            title: Column(
              ...
              children: [
                Text('SwipeActionThreshold: ${ac.selectedProfileValue.swipeActionThreshold?.toStringAsFixed(2)}'),
                Slider(
