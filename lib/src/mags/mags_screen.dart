...
class MagsScreen extends StatefulWidget {
  const MagsScreen({
    super.key,
  });

  @override
  State<MagsScreen> createState() => _MagsScreenState();
}

class _MagsScreenState extends State<MagsScreen> {
  api_magazines.MagazinesSort sort = api_magazines.MagazinesSort.hot;
  String search = "";

  late Future<api_magazines.Magazines> magazines;

  final PagingController<int, api_magazines.Magazine> _pagingController =
        ...
        body: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              PagedSliverList<int, api_magazines.Magazine>(
                pagingController: _pagingController,
                builderDelegate:
                    PagedChildBuilderDelegate<api_magazines.Magazine>(
                  itemBuilder: (context, item, index) => InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        ...
                        OutlinedButton(
                            onPressed: () {},
                            child: Text('Sub ${item.subscriptionsCount}'))
                      ]),
                    ),
                  ),
                ),
